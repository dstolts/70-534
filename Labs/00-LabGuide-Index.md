...
* **Lab Azure AD https://github.com/dstolts/70-534/master/Labs/AzureADLab.pdf** 
* **Lab Creating an Azure AD B2C and Connect an Application https://github.com/dstolts/70-534/master/Labs/AzureADB2CLab.md** 
...
* **Design Advanced Applications https://github.com/dstolts/70-534/master/Labs/AdvancedAppsLab.md**
 
### #5 Design Azure Web and Mobile Apps (5–10%)
* **Creating and Managing a Web App & Services https://github.com/dstolts/70-534/master/Labs/WebAppsLab.md** 
* **Creating and Managing a Mobile App https://github.com/dstolts/70-534/master/Labs/MobileAppsLab.md**
...
* **Azure IaaS monitoring with OMS https://github.com/dstolts/70-534/master/Labs/06-Monitoring-Azure-Automation.md** 
* **Create an alert rule on a metric with the Azure portal https://github.com/dstolts/70-534/master/Labs/06-Monitoring-Create-Alerts.md**  
